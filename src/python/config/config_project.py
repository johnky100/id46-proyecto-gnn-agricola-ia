...
# ------------------------------------------------------------------------------
# Objetivo:
# Validar la estructura oficial del proyecto antes de ejecutar cualquier módulo
...
# ------------------------------------------------------------------------------
# Objetivo:
# Definir la identidad oficial del proyecto y los metadatos científicos
# reutilizados por todos los módulos del Pipeline.
# ¿Qué es el proyecto?
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Objetivo:
# Definir la configuración oficial del Panel Científico, incluyendo su cobertura
# territorial, temporal, espacial, la identidad del Dataset Científico y las
# variables estructurales utilizadas por todos los módulos del Pipeline.
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Objetivo:
# Definir la configuración oficial del GraphData, incluyendo la identidad de
# los nodos, las variables científicas y el método espacial oficial utilizado
...
# ------------------------------------------------------------------------------
# Objetivo:
# Definir la configuración oficial del Benchmark Científico, incluyendo los
# experimentos, los modelos evaluados, las métricas, los criterios de selección
# y los parámetros de reproducibilidad utilizados durante la evaluación.
# ------------------------------------------------------------------------------
...
PRIMARY_METRIC = "rmse" # Métrica principal para construir el ranking oficial
...
# ------------------------------------------------------------------------------
# 4.5 Selección del Modelo Oficial
# ------------------------------------------------------------------------------

SECONDARY_METRIC = "mae" # Métrica utilizada para resolver empates
SELECTION_CRITERION = "min" # Criterio de optimización de la métrica principal

# ------------------------------------------------------------------------------
# 4.6 Reproducibilidad
# ------------------------------------------------------------------------------

BENCHMARK_DETERMINISTIC = True # Ejecutar operaciones determinísticas cuando sea posible
BENCHMARK_RUNS = 1 # Número de ejecuciones independientes del Benchmark

# BLOQUE 5. Entrenamiento del Modelo
# ------------------------------------------------------------------------------
# Objetivo:
# Definir la configuración oficial para el entrenamiento reproducible del modelo
# seleccionado, incluyendo los hiperparámetros, los criterios de optimización y
# los mecanismos de regularización utilizados durante el proceso de aprendizaje.
# ------------------------------------------------------------------------------
...
# incluyendo las métricas utilizadas para evaluar el desempeño predictivo,
# espacial y estructural del proyecto.
# ------------------------------------------------------------------------------
...
# simulación de escenarios futuros del proyecto.
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Objetivo:
# Definir los componentes oficiales que conforman la Plataforma GeoAI para el
# análisis, visualización y apoyo a la toma de decisiones.
# ------------------------------------------------------------------------------
